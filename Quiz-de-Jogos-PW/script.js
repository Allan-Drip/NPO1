...
var postersButtonButton = document.getElementById('postersButton');
...
function renderPosters(){
    ...
    divQuestoes.style.display = 'none';
    divInstrucoes.style.display = 'none';
    divPosters.style.display = 'block';
}
...
function increaseMainBox(fun){
    ...
    postersButton.style.display = 'none';
...
function resetAndGoToMainMenu(){
    ...
    postersButton.style.display = 'block';
